...
public class IPScanner
{
    ...
    private int QQwry()
    {
        ...
        try
        {
            ...
            {
                this.GetCountry();
                this.local = this.local.Replace("（我们一定要解放台湾！！！）", "").Replace("CZ88.NET", "").Replace("台湾省","台湾");
            }
            else
            {
                nRet = 3;
    ...
    {
        try { 
            dataPath = @"C:\Program Files\cz88.net\ip\qqwry.dat";
        ...
        this.QQwry();
        return this.country.Replace("台湾省", "台湾") + "  " + this.local;
    }
